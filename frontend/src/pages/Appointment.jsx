    ...
    return docInfo ? (
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                <div className='flex min-h-[180px] w-full items-center justify-center rounded-lg border border-[#E4E7F0] bg-[#F8FAFF] p-6 sm:max-w-72'>
                    <div className='text-center'>
                        <div className='mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-primary/10 text-3xl font-semibold text-primary'>
                            {docInfo.name ? docInfo.name.charAt(0).toUpperCase() : 'D'}
                        </div>
                        <p className='mt-3 text-sm font-medium text-gray-600'>{docInfo.speciality}</p>
                    </div>
                </div>
